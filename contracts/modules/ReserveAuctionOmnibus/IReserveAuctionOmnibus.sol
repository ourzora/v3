...
interface IReserveAuctionOmnibus {
    ...
    // /// @notice For timed auctions, sets the start time for the auction
    ...
    // /// @notice For token gated auctions, sets the start time for the auction
    // function setTokenGate(
    //   address _tokenContract,
    //   uint256 _tokenId,
    //   address _gateERC20Token,
    //   uint256 _gateMinimumAmount
    // ) external;
    ...
    /// @param _finder The recipient finder address
    function createBid(
        address _tokenContract,
        uint256 _tokenId,
        uint256 _amount,
