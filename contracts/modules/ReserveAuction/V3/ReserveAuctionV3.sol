...
import {IReserveAuctionV3} from "./IReserveAuctionV3.sol";
    ...
    ModuleNamingSupportV1
{
    ...
    function supportsInterface(bytes4 _interfaceId) external pure returns (bool) {
        return _interfaceId == type(IReserveAuctionV3).interfaceId || _interfaceId == 0x01ffc9a7;
    }
    ...
    event AuctionBid(
        address indexed tokenContract, uint256 indexed tokenId, bool firstBid, bool extended, Auction auction
    );
    ...
    function createBid(address _tokenContract, uint256 _tokenId, uint256 _amount, address _finder)
        external
        payable
        nonReentrant
    {
    ...
    function settleAuction(address _tokenContract, uint256 _tokenId) external nonReentrant {
        ...
        (uint256 remainingProfit,) =
            _handleRoyaltyPayout(_tokenContract, _tokenId, auction.highestBid, currency, 300000);
