...
/// @title ReserveAuctionFindersEthIntegrationTest
/// @notice Integration Tests for Reserve Auction Finders ETH
contract ReserveAuctionFindersEthIntegrationTest is DSTest {
    VM internal vm;
    ...
    function runETH() public {
        ...
        vm.warp(1 hours);
        vm.prank(address(bidder));
        auctions.createBid{value: 0.1 ether}(address(token), 0, address(finder));
