...
/// @title ReserveAuctionCoreEthIntegrationTest
/// @notice Integration Tests for Reserve Auction Core ETH
contract ReserveAuctionCoreEthIntegrationTest is DSTest {
    VM internal vm;
    ...
    function runETH() public {
        vm.prank(address(seller));
        auctions.createAuction(address(token), 0, 1 days, 0.1 ether, address(sellerFundsRecipient), 0);
