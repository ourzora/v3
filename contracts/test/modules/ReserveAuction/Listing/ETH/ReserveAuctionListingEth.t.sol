...
/// @title ReserveAuctionListingEthTest
/// @notice Unit Tests for Reserve Auction Listing ETH
contract ReserveAuctionListingEthTest is DSTest {
    VM internal vm;
    ...
    function test_CreateAuction() public {
        vm.prank(address(seller));
        auctions.createAuction(address(token), 0, 1 days, 1 ether, address(sellerFundsRecipient), 0, 1000, address(listingFeeRecipient));
    ...
    function test_CreateFutureAuction() public {
        vm.prank(address(seller));
        auctions.createAuction(address(token), 0, 1 days, 1 ether, address(sellerFundsRecipient), 1 days, 1000, address(listingFeeRecipient));
    ...
    function test_CreateAuctionAndCancelPrevious() public {
        ...
        token.setApprovalForAll(address(erc721TransferHelper), true);
        auctions.createAuction(address(token), 0, 5 days, 12 ether, address(sellerFundsRecipient), 0, 1000, address(listingFeeRecipient));
        vm.stopPrank();
    ...
    function testRevert_ListingFeeBPSCannotExceed10000() public {
        ...
        auctions.createAuction(address(token), 0, 1 days, 1 ether, address(sellerFundsRecipient), 0, 10001, address(listingFeeRecipient));
    }
    ...
    function test_ExtendAuction() public {
        vm.prank(address(seller));
        auctions.createAuction(address(token), 0, 1 hours, 1 ether, address(sellerFundsRecipient), 0, 1000, address(listingFeeRecipient));
    ...
    function testRevert_CannotBidOnExpiredAuction() public {
        vm.prank(address(seller));
        auctions.createAuction(address(token), 0, 10 hours, 1 ether, address(sellerFundsRecipient), 0, 1000, address(listingFeeRecipient));
