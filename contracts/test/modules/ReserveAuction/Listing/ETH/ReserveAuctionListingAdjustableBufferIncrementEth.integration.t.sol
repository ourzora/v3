...
/// @title ReserveAuctionListingAdjustableBufferIncrementEthIntegrationTest
/// @notice Integration Tests for Reserve Auction Listing w/ Adjustable Buffer & Increment ETH
contract ReserveAuctionListingAdjustableBufferIncrementEthIntegrationTest is DSTest {
    VM internal vm;
    ...
    function runETH() public {
        vm.prank(address(seller));
        auctions.createAuction(address(token), 0, 1 days, 0.1 ether, address(sellerFundsRecipient), 0, 1000, address(listingFeeRecipient), 0, 0);
